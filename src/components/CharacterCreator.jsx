  ...
  return (
    <div className="flex flex-col sm:flex-row gap-5 items-start">
      ...
      <div className="flex-shrink-0 flex flex-col items-center gap-2 w-full sm:w-auto">
        <div className="w-24 h-32 relative bg-gradient-to-b from-teal-50 to-teal-100 rounded-2xl border border-teal-200 overflow-hidden">
          {hasTraits && !imgError ? (
            <img
              src={assetUrl}
              alt="Preview"
              className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[145%] max-w-none"
              style={{ top: '6px' }}
