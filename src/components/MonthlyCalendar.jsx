...
export default function MonthlyCalendar({ activities }) {
  ...
  return (
    <div className="-mx-6 px-6 flex flex-col" style={{ height: 'calc(100vh - 120px)' }}>
      {/* Month navigation */}
      <div className="pb-3 -mx-6 px-6 pt-3 flex-shrink-0">
      ...
      {/* Selected day events */}
      <div className="mt-4 flex-1 overflow-y-auto" ref={eventsRef}>
