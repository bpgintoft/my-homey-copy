...
import { Plus, Trash2, ExternalLink, CheckCircle2, Circle, Loader2, Edit2, GripVertical, GraduationCap, Briefcase, Link2, Users, ListTodo, Lightbulb, Target, X, Wrench, CalendarPlus, HeartPulse, FolderOpen, Car, User, Settings2, Check, Activity, Wallet } from 'lucide-react';
          ...
          if (isCustomizing) {
            return (
              ...
              <DragDropContext onDragEnd={handleCustomizeDragEnd}>
                ...
                >
                <span className="absolute right-[-12px] top-1/2 -translate-y-1/2 text-[120px] opacity-[0.07] pointer-events-none select-none leading-none">{icon}</span>
                {icon}
                <span className="font-semibold text-sm text-gray-800 leading-tight">{label}</span>
                </button>
                ))}
