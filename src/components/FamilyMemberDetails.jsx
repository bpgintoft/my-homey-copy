...
import { Plus, Trash2, ExternalLink, CheckCircle2, Circle, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-6 p-6">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Dialog open={dialogOpen.link} onOpenChange={(open) => setDialogOpen({ ...dialogOpen, link: open })}>
            <DialogTrigger asChild>
            ...
            <DialogContent>
              ...
              <div className="space-y-4">
                ...
                <Button
                  ...
                  disabled={!newLink.url || categorizingLink}
                >
