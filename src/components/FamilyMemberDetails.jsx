...
import { Plus, Trash2, ExternalLink, CheckCircle2, Circle, Loader2, Edit2, GripVertical, GraduationCap, Briefcase, Link2, Users, ListTodo, Lightbulb, Target, X, Wrench, CalendarPlus, HeartPulse, FolderOpen } from 'lucide-react';
      ...
      <div className="grid grid-cols-2 gap-2">
        {[
          ...
          <button
            ...
            className={`flex items-center gap-2 p-3 rounded-lg border bg-white hover:shadow-md transition-shadow text-left w-full h-12`}
          >
            {icon}
            <span className="font-semibold text-sm text-gray-800 leading-tight truncate">{label}</span>
          </button>
        ))}
      </div>
