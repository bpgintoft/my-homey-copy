      ...
      <div className="relative">
        ...
        {(() => {
          const sectionIconMap = {
            ...
            schoolProgram: member?.person_type !== 'adult' ? <img src="https://media.base44.com/images/public/6990e4185e2b18f4d04a1ac8/827d57c04_school.png" alt="School" className="w-7 h-7 flex-shrink-0 object-contain" /> : <img src="https://media.base44.com/images/public/6990e4185e2b18f4d04a1ac8/4d5e603a6_briefcase.png" alt="Work" className="w-7 h-7 flex-shrink-0 object-contain" />,
            ...
            return (
              ...
              <DragDropContext onDragEnd={handleCustomizeDragEnd}>
                ...
                <button
                  ...
                  className="relative flex items-center gap-2 p-3 rounded-lg border bg-white hover:shadow-md transition-shadow text-left w-full overflow-hidden"
                >
                  <img src="https://media.base44.com/images/public/6990e4185e2b18f4d04a1ac8/027ba8a4a_finance.png" alt="Financials" className="w-7 h-7 flex-shrink-0 object-contain" />
