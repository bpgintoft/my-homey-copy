...
import { Plus, Trash2, ExternalLink, CheckCircle2, Circle, Loader2, Edit2, GripVertical, GraduationCap, Briefcase, Link2, Users, ListTodo, Lightbulb, Target, X, Wrench, CalendarPlus, HeartPulse, FolderOpen, Car, User, Settings2, Check, Activity, Wallet, MessageCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      ...
      <Dialog open={expandedSection === 'chores'} onOpenChange={(open) => { if (!open) { setExpandedSection(null); setIsReorderingChores(false); } }}>
        <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto top-4 translate-y-0">
          <DialogHeader>
            <DialogTitle className="flex items-center justify-between">
