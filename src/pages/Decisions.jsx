  ...
  return (
    <div className="min-h-screen bg-[#4a3fb5] flex flex-col pb-32 lg:pb-8">
      ...
      <div className="relative overflow-hidden">
        <style>{`
          .decisions-banner {
            background: linear-gradient(135deg, #3730a3 0%, #4f46e5 40%, #6d28d9 100%);
            position: relative;
          }
          .decisions-banner::before {
            ...
            background: repeating-linear-gradient(
              45deg,
              rgba(99, 88, 210, 0.5) 0px,
              rgba(99, 88, 210, 0.5) 10px,
              rgba(79, 70, 229, 0.3) 10px,
              rgba(79, 70, 229, 0.3) 20px,
              rgba(109, 40, 217, 0.4) 20px,
              rgba(109, 40, 217, 0.4) 25px,
              rgba(55, 48, 163, 0.25) 25px,
              rgba(55, 48, 163, 0.25) 30px
            );
          }
        `}</style>
        <div className="decisions-banner px-6 pt-8 pb-6">
