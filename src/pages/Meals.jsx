...
import { Plus, ChefHat, ShoppingCart, Calendar, Clock, Users, Sparkles, Trash2, ExternalLink, BarChart3, Beef, Fish, Leaf, Drumstick, Star, ChevronDown, ChevronUp, Coffee, UtensilsCrossed, Utensils, Apple, IceCream, Search, X } from 'lucide-react';
            ...
            <div className="space-y-4">
              <div className="flex gap-1.5 items-start overflow-x-auto">
                <Button
                  ...
                  variant="outline"
                  className="border-pink-200 text-pink-600 hover:bg-pink-50 px-2.5 flex-shrink-0 text-xs"
                  size="sm"
                >
                  Filter
                </Button>
                <Button
                  ...
                  variant="outline"
                  className={`${showFavoritesOnly ? 'bg-pink-100 border-pink-300' : 'border-pink-200'} text-pink-600 hover:bg-pink-50 px-2 flex-shrink-0`}
                  size="sm"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="border-pink-200 text-pink-600 hover:bg-pink-50 px-2.5 flex-shrink-0 text-xs whitespace-nowrap"
                  size="sm"
                >
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-[#E91E8C] to-[#D01576] text-white px-2.5 flex-shrink-0 text-xs"
                  size="sm"
                >
                          ...
                          {categoryItems.map((item) => (
                            <div key={item.id} className={`flex items-center gap-3 px-3 py-1.5 rounded-lg transition-all ${
                              ...
                              <input
                                ...
                                className="w-5 h-5 rounded border-gray-300 text-pink-600 focus:ring-pink-500 cursor-pointer flex-shrink-0"
                              />
