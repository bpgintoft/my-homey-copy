    ...
    <div className="min-h-screen bg-[#F5F5F7]">
      ...
      <div className="container mx-auto px-6 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="bg-white shadow-sm border-b-2 border-gray-200 rounded-none w-full grid grid-cols-4">
            <TabsTrigger value="rooms" className="border-b-2 border-transparent data-[state=active]:border-emerald-500 data-[state=active]:bg-transparent rounded-none text-xs sm:text-sm px-1">Rooms</TabsTrigger>
            <TabsTrigger value="appliances" className="border-b-2 border-transparent data-[state=active]:border-emerald-500 data-[state=active]:bg-transparent rounded-none text-xs sm:text-sm px-1">Appliances</TabsTrigger>
            <TabsTrigger value="maintenance" className="border-b-2 border-transparent data-[state=active]:border-emerald-500 data-[state=active]:bg-transparent rounded-none text-xs sm:text-sm px-1">Maintenance</TabsTrigger>
            <TabsTrigger value="hardware" className="border-b-2 border-transparent data-[state=active]:border-emerald-500 data-[state=active]:bg-transparent rounded-none text-xs sm:text-sm px-1">
